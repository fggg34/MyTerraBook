            ...
            <div class="border-b border-gray-100 p-4 dark:border-gray-800">
                ...
                <div class="flex flex-wrap gap-1">
                    @foreach ($row['cells'] as $cell)
                        <div
                            class="flex h-10 w-10 flex-col items-center justify-center rounded text-xs {{ $cell['bookings'] > 0 ? 'bg-[#334e68]/10 text-[#243b53] dark:bg-[#334e68]/30 dark:text-slate-100' : 'bg-gray-50 text-gray-500 dark:bg-gray-800' }}"
