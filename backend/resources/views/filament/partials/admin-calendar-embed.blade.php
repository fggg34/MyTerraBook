<x-filament-panels::page>
    ...
    @if ($useInline)
        {{--
            x-init MUST use single quotes. @js()/@json() emit double-quoted JSON;
            putting them inside a double-quoted attribute breaks the HTML and leaves
            the Filament page blank (especially with Sanctum handoff tokens).
        --}}
