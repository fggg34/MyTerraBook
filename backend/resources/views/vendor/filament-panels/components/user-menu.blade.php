            ...
            >
                <span class="relative inline-flex shrink-0">
                    ...
                    @if ($isSidebarCollapsibleOnDesktop)
                        {{
                            \Filament\Support\generate_icon_html(\Filament\Support\Icons\Heroicon::OutlinedCog6Tooth, attributes: new \Illuminate\View\ComponentAttributeBag([
                                'x-show' => '! $store.sidebar.isOpen',
                                'x-cloak' => true,
                                'class' => 'fi-user-menu-collapsed-settings-icon',
                            ]))
                        }}
                    @endif
                </span>
                ...
                >
                    <span class="fi-user-menu-trigger-label">Profile settings</span>
                    <span class="fi-user-menu-trigger-sublabel">{{ filament()->getUserName($user) }}</span>
                </span>
