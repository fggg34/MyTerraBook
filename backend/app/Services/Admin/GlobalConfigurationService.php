...
class GlobalConfigurationService
{
    ...
    public function load(): array
    {
        return [
            ...
            'coming_soon' => filter_var(data_get(Setting::getValue('system.coming_soon', ['enabled' => false]), 'enabled', false), FILTER_VALIDATE_BOOLEAN),
    ...
    public function save(array $state): void
    {
        ...
        Setting::putValue('system.coming_soon', ['enabled' => filter_var($state['coming_soon'] ?? false, FILTER_VALIDATE_BOOLEAN)]);
